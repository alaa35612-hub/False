    ...
    *,
    ...
    def scan_symbol(idx: int, symbol: str):
        try:
            ...
            def _touch_or_inside_liquidity() -> bool:
            ...
            liquidity_touch_or_inside = _touch_or_inside_liquidity()
            ...
            if not recent_hits and not liquidity_touch_or_inside:
            ...
            if liquidity_sweep_recent:
                ...
                reason = "Liquidity Levels Touch/Inside"
            else:
